...
from core.activity_pipeline import ActivityPipeline, POSTURE_ACTIONS
...
def validate(pipeline: ActivityPipeline) -> bool:
    ...
    ok = mod == "core.activity_pipeline"
    all_ok = all_ok and ok
    tag = "[PASS]" if ok else "[FAIL]"
    print(f"  {tag} Module path     -> '{mod}' (must be 'core.activity_pipeline')")
...
if __name__ == "__main__":
    OUTPUT = "models/activity_pipeline.pkl"
